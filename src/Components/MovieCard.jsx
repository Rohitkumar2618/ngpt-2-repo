...
const MovieCard = ({ posterPath, title, onClick }) => {
  return (
    <div
      className="relative w-48 h-72 rounded-md overflow-hidden group transition-transform duration-300 ease-in-out  transform hover:scale-105  hover:z-10 cursor-pointer"
      onClick={onClick}
    >
      {posterPath ? (
        <img
